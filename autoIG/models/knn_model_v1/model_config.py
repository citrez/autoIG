...
past_periods_needed = 5 # how many many rows we need to get a proper prediction
target_periods_in_future =1 # The numer of periods in the future we are trying to predict